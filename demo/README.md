...
```powershell
python demo/python/4_1_sector_full_sync.py --password admin
```
...
python demo/python/4_4_parquet_import.py --password admin --source demo/fixtures/daily_quote.parquet
```
